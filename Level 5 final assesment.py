...
adc = ADC(Pin(26)) # Initialise the Adc pin
uart = UART(0, boadrate=9600, tx=Pin(1), rx=Pin(1)) # Initialise UART module for blutooth communication
...
# Initialise the data file with headers if it does not exit
try:
